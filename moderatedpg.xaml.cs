...
namespace vrchat_active.Views
{
    ...
    public partial class moderatedpg : ContentPage
    {
        ...
        public moderatedpg(string date, string date2)
        {
        ...
        async void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                List<PlayerModeratedResponse> modlist = await api.ModerationsApi.GetPlayerModerations();
