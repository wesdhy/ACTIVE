...
namespace vrchat_active.Views
{
    ...
    public partial class worFavorite : ContentPage
    {
        public IList<serwor> userlist { get; private set; }

        VRChatApi.VRChatApi api;
        public worFavorite(string date, string date2)
        {
        ...
        async void OnButtonClicked()
        {
            ...
            try
            {
                ...
                List<WorldBriefResponse> scaryWorlds = await api.WorldApi.Search(WorldGroups.Favorite, offset: 0, count: 80);
